INSERT INTO ECOMMERCE.brand (brand_id, name)
VALUES (1, 'ZARA');

INSERT INTO ECOMMERCE.product (product_id, name)
VALUES (35455, 'PRODUCT');

INSERT INTO ECOMMERCE.price (price_id, brand_id, start_date, end_date, product_id, priority, price, curr)
